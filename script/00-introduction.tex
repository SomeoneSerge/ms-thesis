...
the ``increments'' do not come from original space, but actually belong in the
...
converted into an increment vector with transpostion, an implicit application
...
The work begins with acquiatance with recently emerged field of hyperbolic deep
