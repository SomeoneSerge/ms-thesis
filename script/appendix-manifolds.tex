\chapter{Optimization on manifolds} \label{appendix:manifolds}
...
\citet{baryPenenc} discuss generalizations of Principal Component Analysis to
...
effort of Max Kochurov, Rasoul Karimov, and your narrator. Starting this
development, the authors hadn't much familiarity with differential geometry,
nor with optimization on manifolds in particular. One of the consequences is
that we simply couldn't have been aware of what use-cases are important, thus
in spite of rather hot discussions, the final API has significant flaws.
